...
(Tick curTime) : Message(curTime) {
    ...
    Cache_RetryTriggerMsg(const Tick curTime, const Addr& local_addr, const Cache_Event& local_event, const MachineID& local_retryDest, const bool& local_usesTxnId)
        : Message(curTime)
    {
        m_addr = local_addr;
        m_event = local_event;
