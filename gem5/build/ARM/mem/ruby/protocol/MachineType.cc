...
MachineType_base_number(const MachineType& obj)
{
    ...
    switch(obj) {
      case MachineType_NUM:
        ...
        [[fallthrough]];
      case MachineType_NULL:
        base += MiscNode_Controller::getNumControllers();
        [[fallthrough]];
      case MachineType_MiscNode:
        base += Memory_Controller::getNumControllers();
        [[fallthrough]];
      case MachineType_Memory:
        base += Cache_Controller::getNumControllers();
        [[fallthrough]];
      case MachineType_Cache:
        base += 0;
        [[fallthrough]];
...
case MachineType_Memory:
return Memory_Controller::getNumControllers();
case MachineType_MiscNode:
return MiscNode_Controller::getNumControllers();
case MachineType_NULL:
return 0;
      case MachineType_NUM:
      default:
